...
export default function DashboardPreview() {
  return (
    <div className="rounded-2xl overflow-hidden border border-[#1E3556] shadow-[0_24px_72px_rgba(0,0,0,0.55)]" style={{ background: "#0A1929" }}>
      {/* Faux browser chrome */}
      ...
      <div className="grid grid-cols-[180px_1fr] max-md:grid-cols-1">
        {/* Sidebar */}
        <aside className="bg-[#102742] border-r border-[#1E3556] p-3 max-md:hidden">
        ...
        <div className="min-w-0">
          {/* Page header */}
          <header className="px-4 py-3 border-b border-[#1E3556] flex items-center justify-between gap-3 flex-wrap">
            <div>
              ...
              <h3 className="text-white font-extrabold text-[15px]">Good morning, Joshua</h3>
            </div>
            <span className="text-[10px] font-bold text-emerald-300 bg-emerald-500/10 border border-emerald-500/30 px-2 py-1 rounded-full">
              ● All systems green
            </span>
          </header>
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              {[
                ...
                <div key={i} className="rounded-xl p-3 border border-[#1E3556]" style={{ background: "linear-gradient(180deg, #15233D 0%, #0F1C32 100%)" }}>
                  ...
                  <div className="text-[8.5px] text-white/45 mt-0.5">{k.sub}</div>
                </div>
              ))}
            </div>
            ...
            >
              <div
                className="w-6 h-6 rounded-full grid place-items-center text-[#0A1929] font-black text-[11px] flex-shrink-0"
            ...
            {/* Driver activity row */}
            <div>
              <div className="text-[10px] font-extrabold uppercase tracking-wider text-white/55 mb-2">
                Driver status · live
              </div>
              <div className="space-y-1.5">
                {[
                  ...
                  <div key={i} className="flex items-center gap-2.5 px-3 py-2 rounded-lg border border-[#1E3556] text-[10.5px]" style={{ background: "#0F1C32" }}>
                    <div className="w-6 h-6 rounded-full grid place-items-center font-extrabold text-[9px] text-[#0A1929] flex-shrink-0"
                      style={{ background: `linear-gradient(135deg, ${d.c}, #22D3EE)` }}>
                      {d.i}
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="text-white font-bold truncate">{d.n}</div>
                      <div className="text-white/55 truncate">{d.s}</div>
                    </div>
