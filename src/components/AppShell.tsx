...
export default function AppShell({
  ...
  return (
    <div className="bg-[#0A1929] min-h-screen text-white flex flex-col">
      ...
      <div className="grid grid-cols-[240px_1fr] max-md:grid-cols-[64px_1fr] flex-1">
        {/* SIDEBAR */}
        <aside className="border-r border-[#1E3556] bg-[#091525] sticky top-16 h-[calc(100vh-64px)] overflow-y-auto flex flex-col">
          <div className="px-3 pt-4 pb-2 border-b border-[#1E3556]">
            <div className="text-[10px] tracking-[.16em] uppercase font-bold text-[#22D3EE]/60 px-2">
              Workspace
            </div>
          </div>
          ...
          <header className="sticky top-16 z-20 bg-[#0A1929]/85 backdrop-blur-md border-b border-[#1E3556]">
            <div className="px-6 h-14 flex items-center justify-between gap-4">
              <div className="min-w-0">
                {crumbs && (
                  <div className="text-[10px] tracking-[.14em] uppercase font-bold text-[#22D3EE]/70 mb-0.5">
                    {crumbs}
                  </div>
                )}
                <h1 className="text-white font-extrabold text-[16px] truncate">{title ?? ""}</h1>
              </div>
