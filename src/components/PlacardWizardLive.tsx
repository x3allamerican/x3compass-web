...
export default function PlacardWizardLive() {
  ...
  return (
    <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 text-left max-w-3xl mx-auto">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-[1fr_1fr] gap-3 mb-3">
            <div className="relative">
              <label className="text-[10px] tracking-[.14em] uppercase font-bold text-[var(--fg-muted)] block mb-1">
              ...
              {placardRequired.required && (
                <>
                  ...
                  <ul className="text-[12px] text-white/80 space-y-1 mb-3">
                    ...
                    <li>• <strong className="text-[var(--fg)]">Shipping papers</strong> per § 172.200 with proper shipping name, UN#, class, PG</li>
                    {subject.class === "1" && (
                      <li>• <strong className="text-[var(--fg)]">Written route plan</strong> required for explosives per § 397.67</li>
                    )}
                    {subject.class === "7" && (
                      <li>• <strong className="text-[var(--fg)]">Highway route-controlled quantity</strong> rules may apply (Class 7)</li>
                    )}
                  </ul>
                </>
              )}
          ...
          {subject && placardRequired?.required ? (
            <>
              <Placard
                ...
                size={200}
              />
              <div className="text-[10px] text-[var(--fg-muted)] mt-3 text-center font-mono leading-relaxed">
