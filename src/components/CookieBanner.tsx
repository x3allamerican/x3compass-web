  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:max-w-md z-50 rounded-2xl border border-[#1E3556] p-5 shadow-2xl" style={{ background: "linear-gradient(180deg, #000000 0%, #0F1C32 100%)" }}>
      ...
      <p className="text-white/65 text-[12px] leading-relaxed mb-4">
        We use cookies essential to running the site (auth session, your carrier ID). Optional cookies · analytics · help us understand how the site is used. Read our <Link href="https://x3compass.com/faq" className="text-[#16C7FF] underline">privacy policy</Link>.
      </p>
