...
export function InspectionImportModal({ carrierId, onClose, onImported }: { carrierId: string; onClose: () => void; onImported: () => void }) {
  ...
  function downloadTemplate() {
    ...
    const a = document.createElement("a"); a.href = URL.createObjectURL(blob); a.download = "inspections_template.csv"; a.click();
  }
  ...
  async function submit() {
    ...
    try {
      const r = await fetch("/api/inspections/import", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ carrier_id: carrierId, csv }) });
