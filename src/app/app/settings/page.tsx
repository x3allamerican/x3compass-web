...
export default function SettingsPage() {
  ...
  if (loading) return <AppShell title="Settings"><div className="p-6 text-[var(--fg-muted)]">Loading…</div></AppShell>;
          ...
          <div className="space-y-6">
            ...
            <Block title="Export your data">
              ...
              <div className="flex gap-2 flex-wrap pt-2">
                ...
                <a href="/app/audit-export" className="px-3 py-1.5 rounded-lg text-[12px] font-bold text-[var(--fg-muted)] hover:text-[var(--fg)] border border-[var(--border)]">View all exports</a>
              </div>
            </Block>
