    ...
    >
      <div className="px-6 py-8 space-y-6">
        ...
        <DataSourceCard
          ...
          connectedVendor="FMCSA SAFER"
          lastSync="auto-pulled from FMCSA · 4 hr ago"
          recordCount={18}
          vendors={[
            { name: "FMCSA SAFER", blurb: "Free public feed · auto-pull every 6h", badge: "Recommended", status: "live", cost: "Included" },
            { name: "J.J. Keller eRODS", blurb: "Inspection import + DataQ filing", badge: "API key", status: "live", cost: "$15/inspection" },
            { name: "Motive Inspections", blurb: "Driver-side roadside inspection capture", badge: "OAuth", status: "live", cost: "Included" },
            { name: "Samsara Compliance", blurb: "Inspection record sync from driver app", badge: "OAuth", status: "live", cost: "Included" },
            { name: "Vigillo / DOT.com", blurb: "CSA score + inspection analysis", status: "manual-pull", cost: "$25/mo" },
            { name: "Manual paper-form upload", blurb: "Photo of paper inspection · OCR'd", badge: "Recommended", status: "live", cost: "Included" },
          ]}
          csvTemplate={{
            name: "x3-compass-inspections-template.csv",
            columns: ["inspection_id", "date", "level", "state", "unit_number", "driver_id", "violations", "oos_violations", "contestable"],
          }}
          manualLabel="Add inspection"
        />
