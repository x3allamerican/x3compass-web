...
function Pill({ cls, children, size = "md" }: { cls: string; children: React.ReactNode; size?: "sm" | "md" }) {
  const sizing = size === "sm" ? "min-w-[88px] px-2 py-1 text-[10px]" : "min-w-[124px] px-3 py-1.5 text-[11px]";
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        <div>
          ...
          <div className="space-y-2.5">
            <div className="flex items-start gap-3"><Pill cls={LEVEL_COLORS[1]} size="sm">LEVEL I</Pill><div className="text-[12px] text-black dark:text-white flex-1"><strong>North American Standard</strong> — most thorough roadside. Driver credentials (CDL, med card, RODS/HOS, Clearinghouse) + 37 vehicle components (brakes, tires, lighting, steering, suspension, coupling, exhaust, fuel, frame, cargo securement). ~30 min.</div></div>
            <div className="flex items-start gap-3"><Pill cls={LEVEL_COLORS[2]} size="sm">LEVEL II</Pill><div className="text-[12px] text-black dark:text-white flex-1"><strong>Walk-around vehicle inspection</strong> — same vehicle items as Level I but inspector does not go under the vehicle. Driver credentials still verified.</div></div>
            <div className="flex items-start gap-3"><Pill cls={LEVEL_COLORS[3]} size="sm">LEVEL III</Pill><div className="text-[12px] text-black dark:text-white flex-1"><strong>Driver-only</strong> — credentials, RODS/HOS, drug & alcohol status, seat belt, Clearinghouse check. No vehicle inspection.</div></div>
            <div className="flex items-start gap-3"><Pill cls={LEVEL_COLORS[4]} size="sm">LEVEL IV</Pill><div className="text-[12px] text-black dark:text-white flex-1"><strong>Special study</strong> — one-time examination of a specific item, typically as part of a research project (e.g. a tire study). Rare.</div></div>
            <div className="flex items-start gap-3"><Pill cls={LEVEL_COLORS[5]} size="sm">LEVEL V</Pill><div className="text-[12px] text-black dark:text-white flex-1"><strong>Vehicle-only</strong> — same as Level I vehicle components, but no driver is present (e.g. terminal yard, scale).</div></div>
            <div className="flex items-start gap-3"><Pill cls={LEVEL_COLORS[6]} size="sm">LEVEL VI</Pill><div className="text-[12px] text-black dark:text-white flex-1"><strong>Enhanced for radioactive shipments</strong> — Level I plus additional requirements specific to highway-route-controlled-quantity radioactive material.</div></div>
          </div>
        </div>
        <div>
          ...
          <div className="space-y-2.5">
            <div className="flex items-start gap-3"><Pill cls={OUTCOME_COLORS.clean} size="sm">CLEAN</Pill><div className="text-[12px] text-black dark:text-white flex-1">No violations cited. Counts as a <strong>clean inspection</strong> for CSA scoring — these actually <em>lower</em> your BASIC scores when reported to SAFER.</div></div>
            <div className="flex items-start gap-3"><Pill cls={OUTCOME_COLORS.violations} size="sm">VIOLATIONS</Pill><div className="text-[12px] text-black dark:text-white flex-1">One or more violations cited but driver / vehicle remained in service. Each violation has a severity weight in the BASIC scoring math. Review for DataQ challenge eligibility.</div></div>
            <div className="flex items-start gap-3"><Pill cls={OUTCOME_COLORS.oos_v} size="sm">OOS - VEHICLE</Pill><div className="text-[12px] text-black dark:text-white flex-1"><strong>Out-of-service vehicle</strong> — the truck or trailer is held at the inspection point until the defect is fixed (49 CFR Appendix G). Tow or roadside repair required.</div></div>
            <div className="flex items-start gap-3"><Pill cls={OUTCOME_COLORS.oos_d} size="sm">OOS - DRIVER</Pill><div className="text-[12px] text-black dark:text-white flex-1"><strong>Out-of-service driver</strong> — driver may not operate for the remainder of a duty period (49 CFR § 395.13 / § 392.5). Common triggers: HOS overage, no CDL, no med card, suspended license.</div></div>
            <div className="flex items-start gap-3"><Pill cls={OUTCOME_COLORS.oos_both} size="sm">OOS - BOTH</Pill><div className="text-[12px] text-black dark:text-white flex-1">Both vehicle and driver placed out-of-service. Highest-impact outcome; vehicle and driver each require remediation before returning to service.</div></div>
          </div>
        </div>
      </div>
