...
function StatusPill({ s }: { s: string }) {
  return (
    <span className={`inline-block min-w-[100px] px-3 py-1 rounded-full text-[10px] font-extrabold border whitespace-nowrap text-center tracking-wider uppercase ${STATUS_PILL[s] || STATUS_PILL.expired}`}>
      {s}
    </span>
  );
}
