...
function Pill({ cls, children, size = "md" }: { cls: string; children: React.ReactNode; size?: "sm" | "md" }) {
  const sizing = size === "sm"
    ? "min-w-[130px] px-3 py-1.5 text-[10px]"
    : "min-w-[130px] px-3 py-1.5 text-[11px]";
  return (
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        <div>
          ...
          <div className="space-y-3.5">
            <div className="grid grid-cols-[140px_1fr] items-start gap-3"><Pill cls={SEV.minor} size="sm">MINOR</Pill><div className="text-[12px] text-black dark:text-white pt-0.5">No injuries. Minor property damage only. No tow required (e.g., low-speed parking-lot contact, fender-bender).</div></div>
            <div className="grid grid-cols-[140px_1fr] items-start gap-3"><Pill cls={SEV.moderate} size="sm">MODERATE</Pill><div className="text-[12px] text-black dark:text-white pt-0.5">Injuries treated and released, or vehicle towed from scene, or property damage requiring repair. Often DOT-recordable.</div></div>
            <div className="grid grid-cols-[140px_1fr] items-start gap-3"><Pill cls={SEV.severe} size="sm">SEVERE</Pill><div className="text-[12px] text-black dark:text-white pt-0.5">Serious injuries requiring transport for medical treatment. Substantial property damage. Disabling damage to one or more vehicles. DOT-recordable per § 390.5T.</div></div>
            <div className="grid grid-cols-[140px_1fr] items-start gap-3"><Pill cls={SEV.fatal} size="sm">FATAL</Pill><div className="text-[12px] text-black dark:text-white pt-0.5">One or more fatalities. Always DOT-recordable. Triggers post-accident drug & alcohol testing under 49 CFR § 382.303 and immediate FMCSA reporting if applicable.</div></div>
          </div>
        </div>
        <div>
          ...
          <div className="space-y-3.5">
            <div className="grid grid-cols-[140px_1fr] items-start gap-3"><Pill cls={PRV.preventable} size="sm">PREVENT</Pill><div className="text-[12px] text-black dark:text-white pt-0.5">Driver could have reasonably done something to avoid the crash. Counts toward the CSA Crash Indicator BASIC. Triggers safety review and corrective action.</div></div>
            <div className="grid grid-cols-[140px_1fr] items-start gap-3"><Pill cls={PRV.non_preventable} size="sm">NON-PREV</Pill><div className="text-[12px] text-black dark:text-white pt-0.5">Driver could not reasonably have prevented the crash. Examples eligible under FMCSA's CPDP: struck by wrong-way / DUI / suicidal driver, hit while legally stopped or parked, struck by debris, hit-and-run, animal strikes.</div></div>
            <div className="grid grid-cols-[140px_1fr] items-start gap-3"><Pill cls={PRV.undetermined} size="sm">UNDET'D</Pill><div className="text-[12px] text-black dark:text-white pt-0.5">Insufficient evidence to make a determination after investigation. Document what was reviewed and why a call could not be made.</div></div>
            <div className="grid grid-cols-[140px_1fr] items-start gap-3"><Pill cls={PRV.pending} size="sm">PENDING</Pill><div className="text-[12px] text-black dark:text-white pt-0.5">Determination not yet made. Investigation in progress (police report, witness statements, ELD/dashcam review). Default state for newly logged accidents.</div></div>
          </div>
        </div>
      </div>
