    ...
    >
      <div className="px-6 py-8 space-y-6">
        ...
        <DataSourceCard
          ...
          cfr="49 CFR § 390.5 (definition) + Part 385 Subpart C"
          initialStatus="manual"
          recordCount={3}
          vendors={[
            { name: "Motive crash detection", blurb: "Auto-creates record when crash detected via dashcam/g-force", badge: "Recommended", status: "live", cost: "Included with Motive" },
            { name: "Samsara AI Dashcam", blurb: "Crash event auto-logged + footage attached", badge: "OAuth", status: "live", cost: "Included" },
            { name: "Lytx DriveCam", blurb: "Event-based capture + reporting", badge: "API key", status: "live", cost: "Included" },
            { name: "SmartDrive (now Lytx)", blurb: "Event capture + coaching workflow", badge: "API key", status: "live", cost: "Included" },
            { name: "Insurance carrier API", blurb: "Sentry, Progressive, GreatWest — claim sync", status: "manual-pull", cost: "Per carrier" },
            { name: "State crash report upload", blurb: "Upload state DPS report PDF · OCR'd", badge: "Recommended", status: "live", cost: "Included" },
          ]}
          csvTemplate={{
            name: "x3-compass-accidents-template.csv",
            columns: ["accident_id", "date", "time", "location", "driver_id", "unit_number", "severity", "recordable", "preventable", "claim_number", "insurer"],
          }}
          manualLabel="Log accident"
        />
