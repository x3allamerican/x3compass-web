          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-[12px] text-white/60">
                Drag-drop scanned medical certs, CDLs, prior-employer letters as a ZIP. OCR + auto-classify + route each PDF to the right slot in the driver&apos;s DQ File. Currently goes through the per-driver upload flow on /app/dq-files.
              </div>
            </div>
          </div>
        </div>
