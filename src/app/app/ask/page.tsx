...
function renderMd(s: string): string {
  return s
    ...
    .replace(/\*(.+?)\*/g, "<em>$1</em>")
    .replace(/`([^`]+)`/g, '<code class="text-[#22D3EE] bg-[var(--bg)] px-1 rounded">$1</code>')
      ...
      <div className="p-6 max-w-4xl mx-auto">
        {messages.length === 0 ? (
          <div className="text-center py-12">
            <div className="w-16 h-16 rounded-full grid place-items-center text-[var(--bg)] font-black text-2xl mx-auto mb-5" style={{ background: "linear-gradient(135deg, #22D3EE, #06B6D4)" }}>∞</div>
