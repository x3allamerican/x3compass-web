...
export default function ScorecardsPage() {
  ...
  if (userLoading) {
    return <AppShell title="Safety Scorecards" crumbs="Drivers · Performance ranking"><div className="px-6 py-12 text-center text-[var(--fg-muted)]">Loading…</div></AppShell>;
  }
