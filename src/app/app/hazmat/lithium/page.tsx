...
const TARGET = "https://x3compass-app-preview.pages.dev/hazmat-lithium.html";

export default function Page() {
  return (
    <AppShell title="Lithium Decision Tree" crumbs="Hazmat · § 173.185">
