/* ============================================================
   ...
   Used ONLY by /app/hazmat/page.tsx (in-app Hazmat Center).
...
const SIDEBAR: Node[] = [
  { kind: "leaf",  id: "dashboard", label: "Dashboard", icon: "dashboard", href: "/app" },
  { kind: "group", id: "driver-brain", title: "Driver Brain", icon: "user", items: [
    { id: "drivers",            label: "Drivers",            href: "/app/drivers",           dot: "emerald" },
    { id: "dq-files",           label: "DQ Files",           href: "/app/dq-files",          dot: "cyan"    },
    { id: "drug-alcohol",       label: "Drug & Alcohol",     href: "/app/drug-alcohol",      dot: "violet"  },
    { id: "hos-eld",            label: "Hours of Service",   href: "/app/hos",               dot: "cyan"    },
    { id: "safety-scorecards",  label: "Safety Scorecards",  href: "/app/scorecards",        dot: "violet"  },
    { id: "training",           label: "Training",           href: "/app/training",          dot: "cyan"    },
  ]},
  { kind: "group", id: "vehicle-brain", title: "Vehicle Brain", icon: "truck", items: [
    { id: "vehicles",     label: "Vehicles",     href: "/app/vehicles",     dot: "cyan"  },
    { id: "inspections",  label: "Inspections",  href: "/app/inspections",  dot: "amber" },
    { id: "accidents",    label: "Accidents",    href: "/app/accidents",    dot: "rose"  },
  ]},
  { kind: "group", id: "ops-brain", title: "Ops Brain", icon: "ops", items: [
    { id: "background-tracker", label: "Background Tracker", href: "/app/background-checks", dot: "amber"   },
    { id: "csa-scores",         label: "CSA Scores",         href: "/app/scorecards",        dot: "amber"   },
    { id: "da-concierge",       label: "D&A Concierge",      href: "/app/da-concierge",      dot: "violet"  },
    { id: "ifta-concierge",     label: "IFTA Concierge",     href: "/app/ifta",              dot: "emerald" },
    { id: "mvr-tracker",        label: "MVR Tracker",        href: "/app/mvr",               dot: "emerald" },
  ]},
  { kind: "group", id: "audit-reports", title: "Audit & Reports", icon: "clipboard", items: [
    { id: "audit-export",     label: "Audit Export",    href: "/app/audit-export",  dot: "emerald" },
    { id: "audit-log",        label: "Audit Log",       href: "/app/audit-log",     dot: "slate"   },
    { id: "notifications",    label: "Notifications",   href: "/app/notifications", dot: "amber"   },
  ]},
  { kind: "group", id: "finance", title: "Finance", icon: "money", pill: { label: "9 AI", color: "emerald" }, items: [
    { id: "finance-dashboard", label: "Finance Dashboard", href: "/app/finance",      dot: "emerald" },
    { id: "finance-team",      label: "AI Finance Team",   href: "/app/finance-team", dot: "violet"  },
    { id: "marketing",         label: "Marketing",         href: "/app/marketing",    dot: "cyan"    },
    { id: "prospects",         label: "FMCSA Prospects",   href: "/app/prospects",    dot: "amber"   },
  ]},
  { kind: "group", id: "integrations", title: "Integrations", icon: "plug", items: [
    { id: "all-integrations", label: "All Integrations", href: "/app/integrations", dot: "slate" },
  ]},
  { kind: "leaf",  id: "ask-compass",  label: "Ask Compass",   icon: "infinity", href: "/app/ask", pill: { label: "AI", color: "violet" } },
  { kind: "group", id: "hazmat-center-group", title: "Hazmat Center", icon: "hazmat", defaultOpen: true,
    pill: { label: "PRO · $99", color: "amber" }, items: [
    { id: "hazmat-center",             label: "Overview",              href: "/app/hazmat",                   dot: "cyan"    },
    { id: "hazmat-placard-wizard",     label: "Placard Wizard",        href: "/app/hazmat/placard-wizard",    dot: "amber"   },
    { id: "hazmat-substances",         label: "Substance Lookup",      href: "/app/hazmat/substances",        dot: "cyan"    },
    { id: "hazmat-lithium",            label: "Lithium Decision Tree", href: "/app/hazmat/lithium",           dot: "amber"   },
    { id: "hazmat-exemptions",         label: "Exemption Checker",     href: "/app/hazmat/exemptions",        dot: "emerald" },
    { id: "hazmat-audit",              label: "Audit Checklist",       href: "/app/hazmat/audit",             dot: "cyan"    },
    { id: "hazmat-shipping-papers",    label: "Shipping Papers",       href: "/app/hazmat/shipping-papers",   dot: "violet"  },
    { id: "hazmat-emergency-response", label: "Emergency Response",    href: "/app/hazmat/emergency-response",dot: "rose"    },
    { id: "hazmat-training",           label: "Training Tracker",      href: "/app/hazmat/training",          dot: "cyan"    },
    { id: "hazmat-security-plan",      label: "Security Plan",         href: "/app/hazmat/security-plan",     dot: "emerald" },
  ]},
  { kind: "group", id: "settings-group", title: "Settings", icon: "gear", items: [
    { id: "settings", label: "Profile", href: "/app/settings", dot: "slate" },
  ]},
];
...
const PILL_COLOR: Record<Dot, { bg: string; fg: string; bd: string }> = {
  ...
  cyan:    { bg: "rgba(34,211,238,0.22)", fg: "#67E8F9", bd: "rgba(34,211,238,0.45)"  },
...
export default function HazmatAppShell({
  ...
  return (
    <>
      ...
      <link rel="stylesheet" href="/x3-static-styles.css" />
      {/* eslint-disable-next-line @next/next/no-css-tags */}
      <link rel="stylesheet" href="/hazmat-center.css" />

      {/* Render the same body[data-page] attribute so hazmat-center.css scoped rules apply */}
      <div data-page="hazmat-center" data-title="Hazmat Center" style={{ background: "#0A1929", minHeight: "100vh" }}>
        <header className="topbar" id="topbar">
          ...
          <div className="topbar-right">
            ...
            <div className="topbar-user">
              <div className="topbar-user-avatar">MA</div>
              <div className="topbar-user-text">
                <div className="topbar-user-name">Michael Anderson</div>
        ...
        <div className="app-shell">
          <aside className="sidebar" id="sidebar">
            <div className="sb2-brand">
              <div className="sb2-x3">X3</div>
              <div className="sb2-brand-text">
                <div className="sb2-brand-name">X3 COMPASS</div>
                <div className="sb2-brand-tag">AI Safety Director</div>
              </div>
            </div>
