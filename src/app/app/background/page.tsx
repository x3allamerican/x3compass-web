    ...
    >
      <div className="px-6 py-8 space-y-6">
        ...
        <DataSourceCard
          ...
          connectedVendor="Checkr"
          lastSync="live"
          recordCount={31}
          vendors={[
            { name: "Checkr", blurb: "Live integration · DOT packages · FCRA-compliant", badge: "Recommended", status: "live", cost: "$59-$129/screening" },
            { name: "Sterling Trucking", blurb: "DAC + employment + MVR bundled", badge: "API key", status: "live", cost: "$89-$149/screening" },
            { name: "HireRight", blurb: "DAC report + drug + medical", badge: "API key", status: "live", cost: "$95-$165/screening" },
            { name: "ProDriverCheck", blurb: "PSP + DAC + MVR + criminal", badge: "API key", status: "live", cost: "$75-$135/screening" },
            { name: "FMCSA PSP", blurb: "Free crash/inspection history via FMCSA", status: "manual-pull", cost: "$10/pull · self-pay to FMCSA" },
            { name: "Foley", blurb: "Driver background packages", status: "manual-pull", cost: "$45-$95/screening" },
          ]}
          csvTemplate={{
            name: "x3-compass-background-template.csv",
            columns: ["screening_id", "candidate_email", "package", "ordered_date", "status", "completed_date", "adjudication"],
          }}
          manualLabel="Add screening record"
        />
