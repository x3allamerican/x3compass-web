...
const RESULT_PILL: Record<TestResult, string> = {
  ...
  Pending:           "bg-[#22D3EE]/15 text-[#22D3EE] border border-[#22D3EE]/30",
};
      ...
      <div className="px-6 py-8 space-y-6">
        ...
        <div className="rounded-2xl border border-[#1E3556] overflow-hidden" style={{ background: "linear-gradient(180deg, #15233D 0%, #0F1C32 100%)" }}>
          <div className="px-5 py-4 border-b border-[#1E3556] flex items-center justify-between flex-wrap gap-2">
            ...
            <span className="text-[12px] font-mono text-[#22D3EE]/80">Part 382 · 5-year retention</span>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-[14px]">
              ...
              <tbody className="divide-y divide-[#1E3556]">
                {TESTS.map((t) => (
                  <tr key={t.id} className="hover:bg-[#22D3EE]/5 transition-colors">
                    ...
                    <td className="py-3 px-4 text-right">
                      <Link href="#" className="text-[13px] font-bold text-[#22D3EE] hover:text-[#67E8F9]">
                        Open →
                      </Link>
                    </td>
                  </tr>
        ...
        <div className="rounded-2xl border border-[#1E3556] overflow-hidden" style={{ background: "linear-gradient(180deg, #15233D 0%, #0F1C32 100%)" }}>
          <div className="px-5 py-4 border-b border-[#1E3556] flex items-center justify-between flex-wrap gap-2">
            ...
            <span className="text-[12px] font-mono text-[#22D3EE]/80">§ 382.701 · § 382.705</span>
          </div>
            ...
            {CH_QUEUE.map((c, i) => (
              <div key={i} className="px-5 py-3.5 flex items-center justify-between gap-3 flex-wrap">
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-9 h-9 rounded-full grid place-items-center font-bold text-[12px] text-[#0A1929] flex-shrink-0"
                    style={{ background: AVATAR_GRAD[c.initials] || "linear-gradient(135deg, #22D3EE, #06B6D4)" }}
                  >
                    {c.initials}
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-4 flex-wrap">
                  ...
                  {c.overdueDays > 0 ? (
                    ...
                    <button className="px-3 py-1.5 rounded-full text-[12px] font-bold text-[#0A1929]"
                      style={{ background: "linear-gradient(135deg, #22D3EE, #06B6D4)" }}
                    >
                      Run query →
                    </button>
