...
/* ============================================================
   /hos · Hours of Service · ELD command center
   ------------------------------------------------------------
      ...
      <div className="p-6 space-y-6">
            ...
            <ul className="space-y-2">
              {watchlist.map((r) => (
                <li key={r.id} className="flex items-center gap-3 px-3 py-2.5 rounded-lg border border-[var(--border)] bg-[var(--surface-2)]">
                  ...
                  <Link
                    href={`/drivers?focus=${r.driver_id}#hos`}
        ...
        <section>
          <header className="flex items-center justify-between mb-3">
            ...
            <Link href="/audit-export?scope=hos" className="text-[11px] font-bold text-[var(--accent)] hover:underline">Export HOS bundle →</Link>
          </header>
