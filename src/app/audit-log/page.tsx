        ...
        <X3AdminHero
          ...
          dataSource={{
            items: [
              ...
              <span key="a4"><strong className="text-[var(--fg)]">Exports</strong> are tenant-scoped JSON/CSV. The Audit Export page (/audit-export) bundles this with all other compass_* tables into one ZIP for offline review.</span>,
            ],
          }}
        />
