...
const COMPONENTS = [
  ...
  { n: "12", title: "Plus everything Direct gets", badge: "FULL PRODUCT",
    desc: "Every X3 product, 300 skills, vendor integrations, audit export, the Hazmat Center included, continuous updates. Partners are first-in-line for new features.",
          ...
          <div className="max-w-7xl mx-auto px-6 pt-20 pb-20 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-[18px] text-[var(--fg-muted)] max-w-2xl mx-auto mb-8 leading-relaxed">
                A white-label AI compliance platform for independent safety consultants. Your brand on the dashboard. Your carriers log into <em>your</em> tool. Powered by 300 published FMCSA skills across the full CFR corpus, sitting invisibly behind your business.
              </p>
