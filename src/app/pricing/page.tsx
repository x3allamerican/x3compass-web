        ...
        <div className="rounded-2xl p-8 border border-[#FACC15] mb-14" style={{ background: "linear-gradient(180deg, #1F2333 0%, #0F1C32 100%)" }}>
          <div className="md:flex md:items-center md:justify-between gap-6">
            <div className="md:flex-1 mb-4 md:mb-0">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-1 mt-4">{HAZMAT_FEATURES.map((f, i) => (<li key={i} className="text-[12px] text-[var(--fg-muted)] flex items-start gap-2"><span className="text-[#FACC15] mt-0.5">▲</span><span>{f}</span></li>))}</ul>
            </div>
