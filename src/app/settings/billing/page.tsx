...
function BillingInner() {
  ...
  useEffect(() => { if (!loading && !user) window.location.href = "/signin?return_to=/settings/billing"; }, [user, loading]);
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--fg)]">
      <div className="max-w-3xl mx-auto px-6 py-12">
        <Link href="/settings" className="text-[12px] text-[var(--fg-muted)] hover:text-[var(--fg)] inline-flex items-center gap-2 mb-6">← Back to settings</Link>
