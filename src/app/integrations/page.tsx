        ...
        {!isSuperAdmin && (
          <div className="x3-card p-5 text-center">
            <div className="text-[12px] text-[var(--fg-muted)]">
              You&apos;re seeing a demo view. <Link href="/control-center" className="text-[var(--accent)] hover:underline font-bold">Sign in as super-admin</Link> to see live probe results.
            </div>
          </div>
        )}
